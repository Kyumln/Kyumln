...
public class Window_LeftBack implements Window {
	...
	public void open() {
		...
		System.out.println("좌측후방 창문을 열었습니다.");
	}
	...
	public void close() {
		...
		System.out.println("좌측후방 창문을 닫았습니다.");
	}
	...
	public void check_state() {
		...
		if(isWindow_state() == true) {
			System.out.println("현재 좌측후방 창문은 열려 있습니다.");
		}else {
			System.out.println("현재 좌측후방 창문은 닫혀 있습니다.");
		}
	}
